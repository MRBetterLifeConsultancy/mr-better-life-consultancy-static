...
$ck_url = "http://" . $_SERVER['HTTP_HOST'] . str_replace(basename($_SERVER['SCRIPT_NAME']), "", $_SERVER['SCRIPT_NAME']);
$ck_base_url = explode("/", $ck_url);
$ck_base_url = $ck_base_url[0] . '/' . $ck_base_url[1] . '/' . $ck_base_url[2] . '/' . $ck_base_url[3] . '/ckfinder/userfiles/';
